...
public partial class BargeDataContextDataContext : System.Data.Linq.DataContext
{
  ...
  partial void InsertCompanys(Companys instance);
  partial void UpdateCompanys(Companys instance);
  partial void DeleteCompanys(Companys instance);
  partial void InsertDraftLevels(DraftLevels instance);
  partial void UpdateDraftLevels(DraftLevels instance);
  partial void DeleteDraftLevels(DraftLevels instance);
  ...
  partial void DeleteEquipment(Equipment instance);
	...
	public BargeDataContextDataContext() : 
	...
	public BargeDataContextDataContext(string connection) : 
			base(connection, mappingSource)
	{
		OnCreated();
	}
	
	public BargeDataContextDataContext(System.Data.IDbConnection connection) : 
			base(connection, mappingSource)
	{
		OnCreated();
	}
	
	public BargeDataContextDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
			base(connection, mappingSource)
	{
		OnCreated();
	}
	
	public BargeDataContextDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
			base(connection, mappingSource)
	{
		OnCreated();
	}
	
	public System.Data.Linq.Table<Companys> Companys
	{
		get
		{
			return this.GetTable<Companys>();
		}
	}
	
	public System.Data.Linq.Table<DraftLevels> DraftLevels
	{
		get
		{
			return this.GetTable<DraftLevels>();
		}
	}
	...
	[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.csp_Duplicate_Barge")]
	public int csp_Duplicate_Barge([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="VarChar(30)")] string oldID, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="VarChar(30)")] string newID)
	{
		IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), oldID, newID);
		return ((int)(result.ReturnValue));
	}
}

[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Companies")]
public partial class Companys : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Companys_Equipment", Storage="_Equipments", ThisKey="CompanyID", OtherKey="CompanyID")]
	...
	{
		this.SendPropertyChanging();
		entity.Companys = this;
	}
	
	private void detach_Equipments(Equipment entity)
	{
		this.SendPropertyChanging();
		entity.Companys = null;
	}
}

[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DraftLevel")]
public partial class DraftLevels : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnDraftLevelChanging(string value);
    partial void OnDraftLevelChanged();
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DraftLevel1", DbType="VarChar(5) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
	public string DraftLevel
	{
		...
		set
		{
			...
			{
				this.OnDraftLevelChanging(value);
				this.SendPropertyChanging();
				this._DraftLevel1 = value;
				this.SendPropertyChanged("DraftLevel");
				this.OnDraftLevelChanged();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Equipment_DraftLevels", Storage="_Equipment", ThisKey="ID", OtherKey="ID", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._Equipment.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.DraftLevel.Remove(this);
				}
				this._Equipment.Entity = value;
				if ((value != null))
				{
					value.DraftLevel.Add(this);
					this._ID = value.ID;
				}
				else
				{
...
public partial class Equipment : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<DraftLevels> _DraftLevel;
	
	private EntityRef<Companys> _Companys;
	...
	public Equipment()
	{
		this._DraftLevel = new EntitySet<DraftLevels>(new Action<DraftLevels>(this.attach_DraftLevel), new Action<DraftLevels>(this.detach_DraftLevel));
		this._Companys = default(EntityRef<Companys>);
		OnCreated();
	}
	...
	public int CompanyID
	{
		...
		set
		{
			if ((this._CompanyID != value))
			{
				if (this._Companys.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnCompanyIDChanging(value);
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Equipment_DraftLevels", Storage="_DraftLevel", ThisKey="ID", OtherKey="ID")]
	public EntitySet<DraftLevels> DraftLevel
	{
		get
		{
			return this._DraftLevel;
		}
		set
		{
			this._DraftLevel.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Companys_Equipment", Storage="_Companys", ThisKey="CompanyID", OtherKey="CompanyID", IsForeignKey=true)]
	public Companys Companys
	{
		get
		{
			return this._Companys.Entity;
		}
		set
		{
			Companys previousValue = this._Companys.Entity;
			if (((previousValue != value) 
						|| (this._Companys.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._Companys.Entity = null;
					previousValue.Equipments.Remove(this);
				}
				this._Companys.Entity = value;
				if ((value != null))
				{
				...
				this.SendPropertyChanged("Companys");
			}
		}
	}
	...
	private void attach_DraftLevel(DraftLevels entity)
	{
		this.SendPropertyChanging();
		entity.Equipment = this;
	}
	
	private void detach_DraftLevel(DraftLevels entity)
	{
		this.SendPropertyChanging();
